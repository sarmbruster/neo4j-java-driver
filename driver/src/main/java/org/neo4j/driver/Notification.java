...
public interface Notification
{
     ...
     * Not all notifications have a unique position to point to and should in that case return
     * an empty position, which is made of -1s.
     *
     * @return the position in the query where the issue was found, or an empty position
     * if no position is associated with this notification.
     */
